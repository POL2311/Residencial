  ...
  function openEvidenceGallery(urls = [], startIndex = 0) {
    ...
    modal.innerHTML = `
      <div class="flex min-h-dvh w-full items-center justify-center p-4 pointer-events-none">
        <div class="flex max-h-[calc(100dvh-2rem)] w-full max-w-4xl flex-col overflow-hidden rounded-[1.35rem] bg-white shadow-2xl pointer-events-auto sm:max-h-[720px]">
