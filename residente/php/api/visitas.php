...
try {
  ...
  service_profile_api_require_module($pdo, $rid, 'residente', 'visitas', 'Las visitas no están habilitadas para este cliente.');
  ...
  app_json_exception($e, 'No pudimos procesar las visitas.');
}
