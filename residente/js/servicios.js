(function () {
    ...
    function ensureDetailModal() {
        ...
        modal.className = 'app-modal-overlay hidden fixed inset-0 z-50 bg-black/70 backdrop-blur-sm';
        modal.innerHTML = `
          <div class="app-modal-viewport min-h-full flex items-center justify-center">
            <div class="app-modal-card w-full max-w-3xl flex-col bg-white shadow-2xl">
              <div class="app-modal-header flex items-center justify-between border-b border-slate-100 px-5 py-4">
              ...
              <div id="residentServicioModalBody" class="app-modal-body"></div>
            </div>
          </div>
        `;
